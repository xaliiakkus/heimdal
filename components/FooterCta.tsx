...
import { footerCta } from "@/lib/data";

export default function FooterCta() {
  return (
    <div className="border-t border-white/10 shadow-lg pointer-events-auto backdrop-blur-xl">
      <div className="max-w-7xl mx-auto p-1">
        <Link href={footerCta.href} target="_blank" rel="noopener noreferrer" className="block group">
